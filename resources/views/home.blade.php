        ...
        <div class="container">
                    ...
                    <div class="col-lg-12">
                        <div class="footer-widget author-logo">
                            ...
                            <div class="footer-content">
                                <h2>Build your On-demand Service
                                    Marketplace with DreamGigs</h2>
                            </div>
                            <div class="banner-wrap-btn justify-content-center">
                                <div class="footer-btn">
                                    <a class="btn btn-primary" href="https://themeforest.net/item/dreamgigs-gig-service-selling-marketplace-bootstrap-html-template/51017661?" target="_blank">
            ...
            <div class="footer-bottom">
                <div class="copy-right">
                    <p>
                        Copyright © <script type="42ab658cf140d6ef405ee4be-text/javascript">
                ...
                <div class="footer-links">
                    <ul>
                        <li>
                            <a href="https://codecanyon.net/legal/market" target="_blank">Term of use</a>
                        </li>
                        <li>
                            <a href="https://codecanyon.net/licenses/standard" target="_blank">License</a>
                        </li>
                        <li>
                            <a href="https://codecanyon.net/page/customer_refund_policy" target="_blank">Refund Policy</a>
                        </li>
                        <li>
                            <a href="https://dreamgigs.dreamstechnologies.com/documentation/" target="_blank">Documentation</a>
                        </li>
                        <li>
                            <a href="https://dreamgigs.dreamstechnologies.com/documentation/#changelog" target="_blank">Logs</a>
                        </li>
                    </ul>
                </div>
